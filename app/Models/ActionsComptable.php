...
class ActionsComptable extends Model {
	...
	*/
	 ...
	 *
	 * @param $message : message facultatif destiné à notifier l'utilisateur du résultat d'une action précédemm ent exécutée
	*/
	public function getLesFichesVisiteurs($message = null)
{   
    return $this->dao->getLesFichesSignees(); 
}	
...
{
    $this->dao->updateEtatFiche($idVisiteur, $mois, 'RF', $motif);
}
